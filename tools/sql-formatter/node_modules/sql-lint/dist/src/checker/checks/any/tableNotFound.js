        ...
        for (const line of query.lines) {
            for (const token of line.tokens) {
                if (token.type === types_1.Types.TableReference) {
                    const reference = (0, lexer_1.extractTableReference)(token.value);
                    if (!this.tables.includes(reference.table) &&
                        reference.table !== "*") {
                        return new checkerResult_1.CheckerResult(line.num, (0, sprintf_js_1.sprintf)(this.message, reference.table, reference.database));
                    }
                }
            }
        }
