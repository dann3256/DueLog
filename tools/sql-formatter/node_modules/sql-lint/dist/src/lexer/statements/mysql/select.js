        ...
        query.lines.forEach((line) => {
            line.content.split(" ").forEach((word) => {
                ...
                if (keywords.includes(item)) {
                    ...
                    item = (0, lexer_1.cleanUnquotedIdentifier)(item);
                    if (item.length > 0) {
                        line.tokens.push(new token_1.Token(types_1.Types.TableReference, (0, lexer_1.cleanUnquotedIdentifier)(item)));
                    }
                }
                else if (lastToken === keywords_1.Keyword.Limit) {
                    item = (0, lexer_1.cleanUnquotedIdentifier)(item);
                    if (item.length > 0) {
                        line.tokens.push(new token_1.Token(types_1.Types.RowCount, (0, lexer_1.cleanUnquotedIdentifier)(item)));
                    }
                }
                else {
